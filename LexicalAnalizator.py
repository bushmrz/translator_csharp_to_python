...
SERVICE_WORDS = ['using', 'namespace', 'int', 'string', 'char', 'float', 'bool', 'true', 'false', 'for', 'foreach', 'goto', 'if',
                 'else', 'while', 'void', 'static', 'Console', 'ulong', 'break', 'continue', 'return', 'new', 'do', 'struct',
                 'in', 'out', 'switch', 'case', 'as', 'Object', 'long', 'null', 'default', 'class', 'double', 'const', 'main']
OPERATIONS = ['=', '+', '-', '*', '/', '%', '<', '>', '==', '!=', '<=', '>=', '&&', '||']
SEPARATORS = ['\t', '\n', ' ', '(', ')', ',', '.', ':', ';', '[', ']', '{', '}', '\'', '"']
